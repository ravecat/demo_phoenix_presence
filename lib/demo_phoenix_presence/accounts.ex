defmodule DemoPhoenixPresence.Accounts do
  @moduledoc """
  The Accounts context.
  """

  import Ecto.Query, warn: false
  alias DemoPhoenixPresence.Repo

  alias DemoPhoenixPresence.Accounts.{User, UserToken, UserNotifier}
  ...
  See `DemoPhoenixPresence.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `DemoPhoenixPresence.Accounts.User.password_changeset/3` for a list of supported options.
